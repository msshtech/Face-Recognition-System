...
directory="D:/C Drive/Desktop/FYP/FRAS"
...
class facerecognitionsystem:
    def __init__(self, FR_wind):
        ...
        img=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\bg2.jpg")
        ...
        #startMarking
        btnImg2=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\f_det.jpg")
        ...
        std_img_btn1=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\save-icon.png")
        ...
        sub_combo["values"]=("Select Subject","Dummy Attendance","Mobile Application","Software Quality","Cloud Computing")
        sub_combo.current(0)
    ...
    def save_raw_Attendance(self,n):
        ...
        def remove_repeated(file):
            ...
            writeFile = open("D:/C Drive/Desktop/FYP/FRAS/text.txt", "w") #bug
    ...
    def markA(self,namelist):
        ...
        if sub!="Select Subject":
            ...
            dateindex=0
            for dtrows in range(5,6):
                for dtcol in range(4,13):
    ...
    def facerecognize(self):
            path = 'D:/C Drive/Desktop/FYP/FRAS/ImagesOfFaces'
            images = []
            classNames = []
