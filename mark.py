...
class FaceDetect:
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\bg2.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\f_det.jpg")
            ...
            for col in range(2,3):
                ...
                for i in namelist:
                    if i==val:
                        ...
                        c1 = ws.cell(row, column)
                        c1.value = "P" 
        wb.save("D:\\C Drive\Desktop\FYP\FRAS\Attendance\sheet3.xlsx")
