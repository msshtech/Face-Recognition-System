...
class student_details:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","BSSE","BSIT","BSCS")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","MAD","HCI","ERP","Software Quality Assurance")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2019-23")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Dell1122@",database="fras")
            ...
            try:
                ...
                while True:
                    ...
                    if face_cropped(frame_my) is not None:
                        ...
                        file_name_path="D:/C Drive/Desktop/FYP/FRAS/ImagesOfFaces/"+str(sname)+".jpg"
