...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\std1.jpg")
        std_img_btn=std_img_btn.resize((180,180),Image.ANTIALIAS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.student_pannels,image=self.std_img1,cursor="hand2")
        std_b1.place(x=270,y=200,width=180,height=180)
        ...
        std_b1_1.place(x=270,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\det1.jpg")
        ...
        # att_b1_1 = Button(bg_img,command=self.attendance_pannel,text="Manage",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\dev.jpg")
        ...
        dev_b1.place(x=690,y=200,width=180,height=180)

        dev_b1_1 = Button(bg_img,command=self.developr,text="Developers",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        dev_b1_1.place(x=690,y=380,width=180,height=45)

        # exit   button 8
        exi_img_btn=Image.open(r"D:\C Drive\Desktop\FYP\FRAS\Images_GUI\exi.jpg")
